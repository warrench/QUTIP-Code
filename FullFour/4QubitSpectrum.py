...
for i,Phi in enumerate(phi):
    ...
    H = QubitHam4_MatterSitesQubits(6,6,0.1,0.1,17.0,16.0,74e-15,67e-15,30.0,30.0e-15,Phi)
...
plt.show()
plt.plot(phi,expect1,'r')
#plt.plot(phi,expect2,'b')
plt.plot(phi,expect3,'g')
plt.plot(phi,expect4,'k')
